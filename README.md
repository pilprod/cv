...
Portrait widths are discrete, not viewport interpolation: 176px up to 360px, 192px from 361–640px, 160px from 641–980px, 152px in the narrow desktop sidebar from 981–1180px, and 172px above 1180px. The screen 8:9 aspect ratio and letter-free crop are unchanged. Desktop/tablet geometry and the two-page PDF remain unchanged by the mobile-only placement.
