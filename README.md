...
September 5 factual correction: Sberbank Insurance Broker was Hybrid, not Remote. Per-experience Domain labels are restored from the five existing, previously hidden Industry domain nodes in the revised Figma page: Aviation & travel; Finance & insurance; Government sector; Cross-industry IT consulting; Telecommunications. They share the dates row where space allows and wrap on narrow screens. The same labels and work arrangement are included in the downloadable PDF and llms.txt.
