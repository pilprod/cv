...
Portrait widths are discrete, not viewport interpolation: 160px up to 360px, 176px from 361–640px, 160px from 641–980px, 152px in the narrow desktop sidebar from 981–1180px, and 172px above 1180px. The screen 8:9 aspect ratio and letter-free crop are unchanged. Desktop/tablet portrait geometry and the two-page PDF remain unchanged by the mobile-only placement. The compact navigation uses a blue Open PDF button matching the role label. Desktop keeps its 36px button and 12px top padding. Up to 640px, the full-width navigation distributes equal space between all four links and at both edges; its links are 32px high with 6px padding above and below, for a 44px header without an extra gap before the CV.
