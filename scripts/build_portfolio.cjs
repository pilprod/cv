...
<link rel="canonical" href="${data.canonical}"><link rel="icon" href="assets/favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="styles.css?v=20260906-language-menu"><link rel="stylesheet" href="portfolio.css?v=20260906-breadboard-1024">
...
<div class="portfolio-toolbar"><a href="/">← Back to CV</a><nav aria-label="Profile links"><a href="https://github.com/pilprod">GitHub</a><a href="${data.linkedin.profile}">LinkedIn</a><span class="language-switch" role="group" aria-label="Language"><a href="/portfolio.html" lang="en" aria-label="English" title="English" aria-current="page"><span aria-hidden="true">🇬🇧</span></a><a href="/ru/portfolio.html" lang="ru" aria-label="Русский" title="Русский"><span aria-hidden="true">🇷🇺</span></a></span><details class="language-menu"><summary aria-label="Choose language, current: English"><span class="current-language-flag" aria-hidden="true">🇬🇧</span><span class="language-caret" aria-hidden="true">▾</span></summary><div class="language-options"><a href="/portfolio.html" lang="en" aria-current="page"><span aria-hidden="true">🇬🇧</span> English</a><a href="/ru/portfolio.html" lang="ru"><span aria-hidden="true">🇷🇺</span> Русский</a></div></details></nav></div>
