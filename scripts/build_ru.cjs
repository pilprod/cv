...
const extras = {
  ...
  'Patterned wallpaper replaced with a neutral wall using AI assistance for privacy.':'Для приватности узорчатые обои заменены нейтральной стеной с помощью AI.',
